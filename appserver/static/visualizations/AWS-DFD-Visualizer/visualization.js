...
// Master Build: 1.9.8 FINAL ICON POLISH (Admin/ISSO & PDP Engine)
// =============================================================================
define([
    'jquery',
    'underscore',
    ...
    function getIconPath(node) {
        ...
        console.log('AWS-DFD 1.9.8 Resolver:', { id: id, type: type, match: iconFile, fullPath: fullPath });
        return fullPath;
    }
    ...
    return SplunkVisualizationBase.extend({
        ...
        updateView: function(data, config) {
            ...
            node.append('image').attr('href', function(d) { return getIconPath(d); }).attr('x', -124).attr('y', -29).attr('width', 58).attr('height', 58).attr('preserveAspectRatio', 'xMidYMid meet').on('error', function() { d3Obj.select(this).attr('href', ICON_BASE + 'generic.svg'); });
