...
interface TypographyParams {
     ...
     * This defaults to `true` if using a `variant`.
     */
    withReset?: boolean;
}
/**
 ...
 *  `'monoBody'`, or
 *  `'monoSmallBody'`,
 * @param {object} [typographyParams] Customize the font settings or element using system values for: `color`, `family`, `lineHeight`, `size`, `weight` and `withReset`.
 * @public
 */
...
declare function typography<T extends AnyTheme, A extends ThemedProps>({ color, family, lineHeight, size, weight, withReset, }: TypographyParams): Interpolation<T, A>;
