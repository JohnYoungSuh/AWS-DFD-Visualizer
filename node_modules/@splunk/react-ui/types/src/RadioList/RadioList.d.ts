...
declare function RadioList({ children, defaultValue: defaultValueProp, describedBy, direction, disabled, elementRef, error, labelledBy, name: nameProp, onChange, required, value: valueProp, ...otherProps }: RadioListProps): React.JSX.Element;
