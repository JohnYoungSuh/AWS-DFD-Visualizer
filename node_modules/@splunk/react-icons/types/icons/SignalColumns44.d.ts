 ...
 * @keywords percentage, stability, sparkline, table cell, status, gauge
 * @variants outlined,filled
 */
declare const SignalColumns44: ({ children, variant, ...otherprops }: IconBaseProps) => React.JSX.Element | null;
