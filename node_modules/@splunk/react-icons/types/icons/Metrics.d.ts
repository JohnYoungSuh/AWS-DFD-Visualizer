...
/**
 * @description Metrics is a type of data
 * @category Data Type
 * @keywords index, datatype, ruler
 * @variants outlined,filled
 */
declare const Metrics: ({ children, variant, ...otherprops }: IconBaseProps) => React.JSX.Element | null;
