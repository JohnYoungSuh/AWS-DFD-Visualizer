 ...
 * @keywords percentage, progress, sparkline, table cell, status, gauge
 * @variants outlined,filled
 */
declare const LevelGauge24: ({ children, variant, ...otherprops }: IconBaseProps) => React.JSX.Element | null;
