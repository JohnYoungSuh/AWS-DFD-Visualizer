 ...
 * @keywords APM, gantt chart, dashboard studio, data visualization editor, waterfall
 * @variants outlined,filled
 */
declare const ChartGantt: ({ children, variant, ...otherprops }: IconBaseProps) => React.JSX.Element | null;
