/******/ (() => {
    ...
    /**
 * @description Zip archive, compressed file
 * @category Reports
 * @keywords document, package, extract
 * @variants outlined,filled
 */    var V = function e(C) {
        var l = C.children, u = C.variant, c = u === void 0 ? "default" : u, d = o(C, [ "children", "variant" ]);
        var V = f(c);
        ...
        return t().createElement(a(), d, l, v ?  t().createElement("use", {
            href: "#".concat(H)
        }) : !!s && s());
    };
