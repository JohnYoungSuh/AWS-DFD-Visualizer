/******/ (() => {
    ...
    function l(e, r) {
        ...
        if (Object.getOwnPropertySymbols) {
            ...
            for (t = 0; t < C.length; t++) {
                L = C[t], -1 === r.indexOf(L) && {}.propertyIsEnumerable.call(e, L) && (n[L] = e[L]);
            }
        }
        return n;
    }
    ...
    /**
 * @description Cold weather, snow and ice, low temperature, frozen
 * @category Objects
 * @keywords freezer, freezing, crystal
 * @variants outlined,filled
 */    var d = function e(r) {
        var C = r.children, o = r.variant, i = o === void 0 ? "default" : o, c = l(r, [ "children", "variant" ]);
        var d = f(i);
        var v = "snowflake-".concat(d);
        var s = (0, L.useContext)(n.IconContext);
        var p = u.get(d);
        if (false) {}
        if (s && p) {
        ...
        return t().createElement(a(), c, C, s ?  t().createElement("use", {
            href: "#".concat(v)
        }) : !!p && p());
    };
