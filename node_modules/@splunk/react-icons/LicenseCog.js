/******/ (() => {
    ...
    const r = require("@splunk/react-icons/IconProvider");
    ...
    function a(e, L) {
        ...
        if (Object.getOwnPropertySymbols) {
            ...
            for (t = 0; t < n.length; t++) {
                C = n[t], -1 === L.indexOf(C) && {}.propertyIsEnumerable.call(e, C) && (r[C] = e[C]);
            }
        }
        return r;
    }
    ...
    var c = function e(L) {
        return L === "default" || L && !i(L) ? "outlined" : L;
    };
    /**
 * @description Management user license or configuration
 * @category Data Type
 * @keywords settings, licensing, checked, flower, badge, gear, award, certification
 * @variants outlined,filled
 */    var f = function e(L) {
        var n = L.children, o = L.variant, d = o === void 0 ? "default" : o, i = a(L, [ "children", "variant" ]);
        var f = c(d);
        var v = "licensecog-".concat(f);
        var p = (0, C.useContext)(r.IconContext);
        var s = u.get(f);
        if (false) {}
        if (p && s) {
        ...
        return t().createElement(l(), i, n, p ?  t().createElement("use", {
            href: "#".concat(v)
        }) : !!s && s());
    };
